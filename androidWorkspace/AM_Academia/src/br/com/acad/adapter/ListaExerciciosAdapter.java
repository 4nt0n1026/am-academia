...
public class ListaExerciciosAdapter extends BaseAdapter {


	private List<Exercicio> itens;
	private Activity activity;

	public ListaExerciciosAdapter(Activity activity, List<Exercicio> itens) {
...
//		imageView.setImageDrawable(image);
		...
		Exercicio item = itens.get(position);
		...
		Drawable icon = activity.getResources().getDrawable(R.drawable.chest);
