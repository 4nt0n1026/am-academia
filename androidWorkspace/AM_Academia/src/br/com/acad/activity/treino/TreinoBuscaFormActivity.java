...
public class TreinoBuscaFormActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.treino_busca_form_layout);
	...
	public void buscarTreino(View btnBuscar){
		Intent goListBuscaTreino = new Intent(this, TreinoBuscaResultActivity.class);
