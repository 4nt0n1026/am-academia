...
public class NoticiaDAOImpl extends DAOImpl<Noticia,Integer> implements NoticiaDAO{
	...
	public long contarTodos(String search) {
		Query q = getEntityManager().createQuery(SqlLogic.getCountSql(Noticia.STATIC_FIELDS, "Noticia", search));
		return  (Long) q.getSingleResult();
	}

	@Override
	public List<Noticia> buscarTodos(int page, String txtSearch, String order) {
		TypedQuery<Noticia> q = getEntityManager().createQuery(SqlLogic.getSql(Noticia.STATIC_FIELDS, "Noticia", txtSearch, order), Noticia.class);
	...
	public List<Noticia> filtrarTodos(int page, Map<String, String> filtros, String order){
		TypedQuery<Noticia> q = getEntityManager().createQuery(SqlLogic.getFilterSql(filtros, "Noticia", order), Noticia.class);
	...
	public long contarTodosFiltro(Map<String, String> filtros) {
		Query q = getEntityManager().createQuery(SqlLogic.getCountFilterSql("Noticia", filtros));
		return  (Long) q.getSingleResult();
	}
}
