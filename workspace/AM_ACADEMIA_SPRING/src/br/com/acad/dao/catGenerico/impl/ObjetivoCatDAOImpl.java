...
public class ObjetivoCatDAOImpl extends DAOImpl<ObjetivoCat,Integer> implements ObjetivoCatDAO{
	...
	public long contarTodos(String search) {
		Query q = getEntityManager().createQuery(SqlLogic.getCountSql(ObjetivoCat.STATIC_FIELDS, "ObjetivoCat", search));
		return  (Long) q.getSingleResult();
	}

	@Override
	public List<ObjetivoCat> buscarTodos(int page, String txtSearch, String order) {
		TypedQuery<ObjetivoCat> q = getEntityManager().createQuery(SqlLogic.getSql(ObjetivoCat.STATIC_FIELDS, "ObjetivoCat", txtSearch, order), ObjetivoCat.class);
