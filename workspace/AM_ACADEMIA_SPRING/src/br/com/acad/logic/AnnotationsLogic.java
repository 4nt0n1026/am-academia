...
public class AnnotationsLogic {
	...
	/**
	 * Gera array de valores de mapeamento de campos de busca para pagina, passando por parametro o(s) tipo(s) da(a) classe(s) referente(s).
	 * É ultizado varias classes para caso de herança.
	 * Utiliza Annotation @Search para indentificar os valores.
	 * @param clazz
	 * @return
	 */
	...
	/**
	 * Gera array de valores de mapeamento de campos de ordenacao da pagina, passando por parametro o(s) tipo(s) da(a) classe(s) referente(s).
	 * É ultizado varias classes para caso de herança.
	 * Utiliza Annotation @Search para indentificar os valores nas classes models.
	 * @param clazz
	 * @return
	 */
	...
	/**
	 * Gera array de label de campos de ordenacao da pagina, passando por parametro o(s) tipo(s) da(s) classe(s) referente(s).
	 * É ultizado varias classes para caso de herança.
	 * Utiliza Annotation @Search para indentificar os valores.
	 * @param clazz
	 * @return
	...
	/**
	 * Gera array de valores de mapeamento de campos de view da pagina, passando por parametro o(s) tipo(s) da(a) classe(s) referente(s).
	 * É ultizado varias classes para caso de herança.
	 * Utiliza Annotation @Search para indentificar os valores.
	 * @param clazz
	 * @return
	...
	/**
	 * Gera array de label de campos de view da pagina, passando por parametro o(s) tipo(s) da(s) classe(s) referente(s).
	 * É ultizado varias classes para caso de herança.
	 * Utiliza Annotation @Search para indentificar os valores.
	 * @param clazz
	 * @return
