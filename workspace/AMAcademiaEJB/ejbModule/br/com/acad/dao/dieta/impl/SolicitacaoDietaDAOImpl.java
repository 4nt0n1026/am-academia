...
public class SolicitacaoDietaDAOImpl extends DAOImpl<SolicitacaoDieta,Integer> implements SolicitacaoDietaDAO{
	...
	public long contarTodos(String search) {
		Query q = em.createQuery(SqlLogic.getCountSql(SolicitacaoDieta.STATIC_FIELDS, "SolicitacaoDieta", search));
		return  (Long) q.getSingleResult();
	}

	@Override
	public List<SolicitacaoDieta> buscarTodos(int page, String txtSearch, String order) {
		TypedQuery<SolicitacaoDieta> q = em.createQuery(SqlLogic.getSql(SolicitacaoDieta.STATIC_FIELDS, "SolicitacaoDieta", txtSearch, order), SolicitacaoDieta.class);
	...
	public List<SolicitacaoDieta> filtrarTodos(int page, Map<String, String> filtros, String order){
		TypedQuery<SolicitacaoDieta> q = em.createQuery(SqlLogic.getFilterSql(filtros, "SolicitacaoDieta", order), SolicitacaoDieta.class);
	...
	public long contarTodosFiltro(Map<String, String> filtros) {
		Query q = em.createQuery(SqlLogic.getCountFilterSql("SolicitacaoDieta", filtros));
		return  (Long) q.getSingleResult();
	}
